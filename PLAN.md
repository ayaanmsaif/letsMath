...
- **M4 AI draws anything:**
  ...
  - **the validation retry loop, now the priority:** a refused drawing currently leaves the tutor saying "here it is" over an empty board, and the student is never told;
